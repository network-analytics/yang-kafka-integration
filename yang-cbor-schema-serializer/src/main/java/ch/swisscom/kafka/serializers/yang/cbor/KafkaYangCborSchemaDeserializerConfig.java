...
public class KafkaYangCborSchemaDeserializerConfig extends AbstractKafkaSchemaSerDeConfig {
  ...
  public static final String YANG_CBOR_FAIL_UNKNOWN_PROPERTIES_DOC =
      "Whether to fail " + "deserialization if unknown YANG-CBOR properties are encountered";
  ...
  public static final String YANG_CBOR_FAIL_INVALID_SCHEMA_DOC =
      "Whether to fail deserialization" + "if the YANG-CBOR payload does not match the schema";

  public static final String YANG_CBOR_KEY_TYPE = "yang.cbor.key.type";
  public static final String YANG_CBOR_KEY_TYPE_DEFAULT = Object.class.getName();
  public static final String YANG_CBOR_KEY_TYPE_DOC =
      "Classname of the type that the message key " + "should be deserialized to";

  public static final String YANG_CBOR_VALUE_TYPE = "yang.cbor.value.type";
  public static final String YANG_CBOR_VALUE_TYPE_DEFAULT = Object.class.getName();
  public static final String YANG_CBOR_VALUE_TYPE_DOC =
    ...
    config =
        baseConfigDef()
            ...
            .define(
                ...
                YANG_CBOR_KEY_TYPE_DEFAULT,
                ConfigDef.Importance.MEDIUM,
                YANG_CBOR_KEY_TYPE_DOC)
            .define(
                YANG_CBOR_VALUE_TYPE,
                ConfigDef.Type.CLASS,
                YANG_CBOR_VALUE_TYPE_DEFAULT,
                ConfigDef.Importance.MEDIUM,
                YANG_CBOR_VALUE_TYPE_DOC);
  }

  public KafkaYangCborSchemaDeserializerConfig(Map<?, ?> props) {
    super(config, props);
  }
}
