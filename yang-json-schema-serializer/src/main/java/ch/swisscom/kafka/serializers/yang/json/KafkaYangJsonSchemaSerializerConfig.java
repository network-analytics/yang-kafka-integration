...
public class KafkaYangJsonSchemaSerializerConfig extends AbstractKafkaSchemaSerDeConfig {
  ...
  public static final String YANG_JSON_FAIL_UNKNOWN_PROPERTIES_DOC =
      "Whether to fail serialization" + " if unknown YANG-JSON properties are encountered";
  ...
  public static final String YANG_JSON_FAIL_INVALID_SCHEMA_DOC =
      "Whether to fail serialization if" + " the YANG-JSON payload does not match the schema";
  ...
  public KafkaYangJsonSchemaSerializerConfig(Map<?, ?> props) {
    super(config, props);
  }
}
